            ...
            >
                <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-gray-200/50 dark:border-gray-700/50">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Create Account</h2>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Join to unlock unlimited AI samples</p>
                    </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-4">
                        ...
                        <motion.button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-3 px-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
