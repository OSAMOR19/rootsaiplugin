...
interface DraggableSampleProps {
  ...
  showCheckbox?: boolean // NEW: Whether to show selection checkbox
}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center p-2 sm:p-3 lg:p-4 space-x-2 sm:space-x-3 lg:space-x-4">
        {/* Selection checkbox on the far left - Optional */}
        {showCheckbox && (
        ...
        <div className="flex-shrink-0 flex items-center space-x-1 sm:space-x-2">
          ...
          <div className="relative">
            <SampleActionsMenu
              sample={sample}
              buttonClass="w-7 h-7 sm:w-8 sm:h-8 rounded-full text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center justify-center"
            />
          </div>
        </div>
      </div>
